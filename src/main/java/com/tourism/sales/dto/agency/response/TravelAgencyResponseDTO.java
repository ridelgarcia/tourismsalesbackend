...
public class TravelAgencyResponseDTO extends NodeResponseDTO{
  ...
  public TravelAgencyResponseDTO() {
    super();
  } 

  public TravelAgencyResponseDTO(int errorCode, String errorDescription, String id, String name,
  ...
  public String toString() {
    return "TravelAgencyResponseDTO [phone=" + phone + ", email=" + email + ", id=" + id + ", name="
